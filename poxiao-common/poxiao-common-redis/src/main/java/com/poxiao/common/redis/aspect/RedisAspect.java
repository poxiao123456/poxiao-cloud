package com.poxiao.common.redis.aspect;

import com.poxiao.common.redis.annotation.RedisCache;
import com.poxiao.common.redis.annotation.RedisEvict;
import com.poxiao.common.redis.util.RedisUtils;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.poxiao.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.poxiao.common.redis.annotation.RedisEvict)")
